        ...
        <div className="marquee-track text-secondary font-bold text-sm sm:text-base whitespace-nowrap">
          {Array.from({ length: 2 }).map((_, k) => (
            <div key={k} className="flex items-center gap-8 pr-8">
              {["⚡ Lãi suất 0% trong 18 tháng — Ân hạn gốc ","💎 Chỉ còn 12 căn cuối khu Vịnh Thiên Đường","🌊 Sở hữu lâu dài — View vịnh Hạ Long trực diện","⚡ Lãi suất 0% trong 18 tháng — Ân hạn gốc ","🏆 Vinhomes — Chủ đầu tư uy tín #1 Việt Nam"].map((t, i) => (
